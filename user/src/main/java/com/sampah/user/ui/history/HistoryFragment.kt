...
import com.sampah.user.databinding.FragmentHistoryBinding
import com.sampah.user.notifications.StatusMonitoringService
    ...
    private fun setListHistory() {
        ...
        if (currentUser != null) {
            firestore.collection("users")
                ...
                .orderBy("tanggalPenjemputan", Query.Direction.DESCENDING)
                .get()
